...
public class FindRecordIsDo implements FindRecord {

	@Override
	public ResultSet findMyRecord(MysqlImpl mysql, String name) 
			throws SQLException {
		String sql = "select * from test1.leave where isPass= '未审核' and name = ?order by date,leaveDay";
	...
	public ResultSet findMyRecordStartX(MysqlImpl mysql, String name, int x,
		...
		String sql = "select * from test1.leave where isPass= '未审核' and  name = ? order by date,leaveDay limit ?,?;";
		PreparedStatement prst = mysql.execute(sql);
		prst.setString(1, name);
		prst.setInt(2, x);
		prst.setInt(3, n);
	...
	public ResultSet findRecordByDepartment(MysqlImpl mysql, String department)
			throws SQLException {
		String sql = "select * from test1.leave where isPass= '未审核' and  department = ?order by date,leaveDay";
		PreparedStatement prst = mysql.execute(sql);
	...
	public ResultSet findRecordByDepartmentStartX(MysqlImpl mysql,
		...
		String sql = "select * from test1.leave where isPass= '未审核' and  department = ? order by date,leaveDay limit ?,?;";
		PreparedStatement prst = mysql.execute(sql);
		prst.setString(1, department);
		prst.setInt(2, x);
		prst.setInt(3, n);
	...
	public ResultSet findRecordByNameAndDepartment(MysqlImpl mysql,
		...
		String sql = "select * from test1.leave where isPass= '未审核' and  name = ? and department = ? order by date,leaveDay;";
		PreparedStatement prst = mysql.execute(sql);
		prst.setString(1, name);
	...
	public ResultSet findRecordByNameAndDepartmentStartX(MysqlImpl mysql,
		...
		String sql = "select * from test1.leave where isPass= '未审核' and  name = ? and department = ? order by date,leaveDay limit ?,?;";
		PreparedStatement prst = mysql.execute(sql);
		prst.setString(1, name);
		prst.setString(2, department);
		prst.setInt(3, x);
	...
	public ResultSet findAll(MysqlImpl mysql) throws SQLException {
		String sql = "select * from test1.leave where  isPass= '未审核' order by date,leaveDay;";
		PreparedStatement prst = mysql.execute(sql);
		ResultSet resultSet = prst.executeQuery();
		return resultSet;
	}
	...
	public ResultSet findAllStartX(MysqlImpl mysql, int x, int n)
			throws SQLException {
		String sql = "select * from test1.leave where isPass= '未审核' order by date,leaveDay limit ?,?;";
		PreparedStatement prst = mysql.execute(sql);
		prst.setInt(1, x);
		prst.setInt(2, n);
		ResultSet resultSet = prst.executeQuery();
